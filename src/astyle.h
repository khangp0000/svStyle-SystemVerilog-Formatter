...
/* The enums below ave been moved up from inside the namespace astyle, since
   they for some strange reason are not recognized by 'vectors' in Microsoft
   Visual C++ 5 when they are part of a namespace!!! There was no such problem
   with GNU's g++ compiler.
*/
...
class ASResource {
 public:
  static const string AS_MODULE, AS_ENDMODULE;
  ...
  static const string AS_PLUS, AS_MINUS, AS_MULT, AS_EXP, AS_DIV, AS_MOD, AS_GR,
      AS_LS;
  ...
  static const string AS_BEGIN, AS_GENERATE, AS_CASE, AS_CASEX, AS_CASEZ,
      AS_FUNCTION, AS_FORK, AS_TABLE, AS_TASK, AS_SPECIFY,
      AS_PRIMITIVE;  // add verilog

  static const string AS_END, AS_ENDGENERATE, AS_ENDCASE, AS_ENDFUNCTION,
      AS_JOIN, AS_ENDTASK, AS_ENDTABLE, AS_ENDSPECIFY, AS_ENDPRIMITIVE;

  static const string AS_INITIAL, AS_FOREVER, AS_ALWAYS, AS_REPEAT;

  // SystemVerilog
  static const string AS_FOREACH;
  static const string AS_ALWAYS_FF, AS_ALWAYS_COMB, AS_ALWAYS_LATCH;
  static const string AS_RANDCASE, AS_CLASS, AS_CLOCKING, AS_COVERGROUP,
      AS_INTERFACE, AS_PACKAGE, AS_PROGRAM, AS_PROPERTY, AS_SEQUENCE,
      AS_RANDSEQUENCE;
  static const string AS_JOIN_ANY, AS_JOIN_ALL, AS_ENDCLASS, AS_ENDCLOCKING,
      AS_ENDGROUP, AS_ENDINTERFACE, AS_ENDPACKAGE, AS_ENDPROGRAM,
      AS_ENDPROPERTY, AS_ENDSEQUENCE;
...
class ASBeautifier : protected ASResource {
 public:
  ...
  virtual void init(
      ASStreamIterator *iter);  // pointer to dynamically created iterator.
  virtual void init();
