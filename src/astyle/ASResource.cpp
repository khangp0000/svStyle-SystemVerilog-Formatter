...
const string ASResource::PRO_NOUNCONNECTED_DRIVE =
    string("`nounconnected_drive");
...
// SystemVerilog added
const string ASResource::AS_RANDCASE = string("randcase");
const string ASResource::AS_CLASS = string("class");
const string ASResource::AS_CLOCKING = string("clocking");
const string ASResource::AS_COVERGROUP = string("covergroup");
const string ASResource::AS_INTERFACE = string("interface");
const string ASResource::AS_PACKAGE = string("package");
const string ASResource::AS_PROGRAM = string("program");
const string ASResource::AS_PROPERTY = string("property");
const string ASResource::AS_SEQUENCE = string("sequence");
const string ASResource::AS_RANDSEQUENCE = string("randsequence");
// end added
...
// SystemVerilog added
const string ASResource::AS_JOIN_ANY = string("join_any");
const string ASResource::AS_JOIN_ALL = string("join_all");
const string ASResource::AS_ENDCLASS = string("endclass");
const string ASResource::AS_ENDCLOCKING = string("endclocking");
const string ASResource::AS_ENDGROUP = string("endgroup");
const string ASResource::AS_ENDINTERFACE = string("endinterface");
const string ASResource::AS_ENDPACKAGE = string("endpackage");
const string ASResource::AS_ENDPROGRAM = string("endprogram");
const string ASResource::AS_ENDPROPERTY = string("endproperty");
const string ASResource::AS_ENDSEQUENCE = string("endsequence");
// end added
